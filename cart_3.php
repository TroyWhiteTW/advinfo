            ...
            <div class="col-sm-10">
                ...
                <div class="content-area">
                    ...
                    <div class="content-article">
                        ...
                        <div class="form-tittle">折抵金額：<div class="form-input-2">資料填入</div></div>
                ...
                <div class="content-article">
                    ...
                    <div class="form-tittle">姓名：<div class="form-input-2">資料填入</div></div>

                    <div class="form-tittle">電子信箱：<div class="form-input-2">資料填入</div></div>

                    <div class="form-tittle">聯繫電話：<div class="form-input-2">資料填入</div></div>

                    <div class="form-tittle">手機：<div class="form-input-2">資料填入</div></div>

                    <div class="form-tittle">聯繫地址：<div class="form-input-2">資料填入</div></div>
                ...
                <div class="content-article">
                    ...
                    <div class="form-tittle">統一編號：<div class="form-input-2">資料填入</div></div>

                    <div class="form-tittle">公司抬頭：<div class="form-input-2">資料填入</div></div>
